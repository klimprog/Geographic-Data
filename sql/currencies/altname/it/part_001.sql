...
('AED', 'it', 'dirham degli Emirati Arabi Uniti'),
('AFN', 'it', 'afghani'),
('ALL', 'it', 'lek albanese'),
('AMD', 'it', 'dram armeno'),
...
('MXV', 'it', 'unidad de inversion (UDI) messicana'),
...
('USN', 'it', 'dollaro statunitense (next day)'),
('UYI', 'it', 'peso uruguaiano in unità indicizzate'),
('UYU', 'it', 'peso uruguayano'),
('UYW', 'it', 'Unidad Previsional'),
('UZS', 'it', 'sum uzbeco'),
('VED', 'it', 'Bolívar Soberano'),
('VES', 'it', 'bolívar venezuelano'),
('VND', 'it', 'dong vietnamita'),
('VUV', 'it', 'vatu di Vanuatu'),
('WST', 'it', 'tala samoano'),
('XAD', 'it', 'Arab Accounting Dinar'),
('XAF', 'it', 'franco CFA BEAC'),
('XAG', 'it', 'argento'),
('XAU', 'it', 'oro'),
('XBA', 'it', 'unità composita europea'),
('XBB', 'it', 'unità monetaria europea'),
('XBC', 'it', 'unità di acconto europea (XBC)'),
('XBD', 'it', 'unità di acconto europea (XBD)'),
('XCD', 'it', 'dollaro dei Caraibi orientali'),
('XCG', 'it', 'Caribbean Guilder'),
...
('XPT', 'it', 'platino'),
('XSU', 'it', 'Sucre'),
('XTS', 'it', 'codice di verifica della valuta'),
('XUA', 'it', 'ADB Unit of Account'),
('XXX', 'it', 'valuta sconosciuta'),
('YER', 'it', 'riyal yemenita'),
