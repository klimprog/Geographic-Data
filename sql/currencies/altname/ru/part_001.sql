...
('COU', 'ru', 'Единица реальной стоимости Колумбии'),
...
('MXV', 'ru', 'Мексиканская пересчетная единица (UDI)'),
...
('USD', 'ru', 'доллар США'),
('USN', 'ru', 'Доллар США следующего дня'),
('UYI', 'ru', 'Уругвайский песо (индекс инфляции)'),
('UYU', 'ru', 'уругвайский песо'),
('UYW', 'ru', 'Unidad Previsional'),
('UZS', 'ru', 'узбекский сум'),
('VED', 'ru', 'Bolívar Soberano'),
('VES', 'ru', 'венесуэльский боливар'),
('VND', 'ru', 'вьетнамский донг'),
('VUV', 'ru', 'вату Вануату'),
('WST', 'ru', 'самоанская тала'),
('XAD', 'ru', 'Arab Accounting Dinar'),
('XAF', 'ru', 'франк КФА BEAC'),
('XAG', 'ru', 'Серебро'),
('XAU', 'ru', 'Золото'),
('XBA', 'ru', 'Европейская составная единица'),
('XBB', 'ru', 'Европейская денежная единица'),
('XBC', 'ru', 'расчетная единица европейского валютного соглашения (XBC)'),
('XBD', 'ru', 'расчетная единица европейского валютного соглашения (XBD)'),
('XCD', 'ru', 'восточно-карибский доллар'),
('XCG', 'ru', 'Caribbean Guilder'),
...
('XPT', 'ru', 'Платина'),
('XSU', 'ru', 'Sucre'),
('XTS', 'ru', 'тестовый валютный код'),
('XUA', 'ru', 'ADB Unit of Account'),
('XXX', 'ru', 'неизвестная валюта'),
('YER', 'ru', 'йеменский риал'),
('ZAR', 'ru', 'южноафриканский рэнд'),
('ZMW', 'ru', 'замбийская квача'),
('ZWG', 'ru', 'Zimbabwe Gold');
