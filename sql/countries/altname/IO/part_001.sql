...
('IO', 'aa', 'British Indian Ocean Territory'),
('IO', 'am', 'የብሪታኒያ ህንድ ውቂያኖስ ግዛት'),
('IO', 'ar', 'الإقليم البريطاني في المحيط الهندي'),
('IO', 'az', 'Britaniyanın Hind Okeanı Ərazisi'),
...
('IO', 'dv', 'އިނގިރޭސި އިންޑިއަން އޯޝަން ޓެރިޓަރީ އެވެ'),
...
('IO', 'ht', 'Territoire britannique de l’océan Indien'),
...
('IO', 'nl', 'Brits Indische Oceaanterritorium'),
('IO', 'no', 'Det britiske territoriet i Indiahavet'),
('IO', 'ny', 'British Indian Ocean Territory'),
...
('IO', 'sm', 'British Indian Ocean Territory'),
